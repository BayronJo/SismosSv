package com.sismossv.sismossv.mapa;
...
import com.sismossv.sismossv.mapa.path.GsonRequest;
import com.sismossv.sismossv.mapa.path.Helper;
import com.sismossv.sismossv.mapa.path.VolleySingleton;
import com.sismossv.sismossv.mapa.path.model.DirectionObject;
import com.sismossv.sismossv.mapa.path.model.LegsObject;
import com.sismossv.sismossv.mapa.path.model.PolylineObject;
import com.sismossv.sismossv.mapa.path.model.RouteObject;
import com.sismossv.sismossv.mapa.path.model.StepsObject;

import java.util.ArrayList;
import java.util.List;


public class Mapa extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleApiClient.OnConnectionFailedListener,
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        ...
                        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                            ...
                            ActivityCompat.requestPermissions(Mapa.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_LOCATION_REQUEST_CODE);
                        }
                        break;
    ...
    private void showPermissionAlert() {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Mapa.this, "Permiso negado.", Toast.LENGTH_LONG).show();
            }
        });
        builder.show();
    }
    ...
    private void setDefaultMarkerOption(LatLng location) {
        if (yourLocationMarker == null) {
            ...
            mMap.addMarker(new MarkerOptions().position(latLng).title(this.tituloDestino));
            ...
            public void onResponse(DirectionObject response) {
                try {
                    ...
                    if (response.getStatus().equals("OK")) {
                        ...
                        Toast.makeText(Mapa.this, "Error de servidor.", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
